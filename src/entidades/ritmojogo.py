...
class RitmoJogo:
    ...
    def modificar_tempo(tempo):
        ...
        try:
            ...
            print(
                "Formato de tempo inválido. Use o formato 'minutos:segundos' ou 'minutos'."
            )
            return None
...
def _adicionar_filtro(
    tempo_minimo_inicial=None, tempo_maximo_inicial=None, acrescimo_maximo=None
):
    """
...
def selecionar_ritmos_de_jogo(
    ...
    str_filtros = _adicionar_filtro(
        tempo_minimo_inicial, tempo_maximo_inicial, acrescimo_maximo
    )
    filtros = [
        lambda ritmo: _filtrar_por_tempo_inicial_minimo(
            ritmo_de_jogo=ritmo, tempo_minimo_inicial=tempo_minimo_inicial
        ),
        lambda ritmo: _filtrar_por_acrescimo_maximo(
            ritmo_de_jogo=ritmo, acrescimo_maximo=acrescimo_maximo
        ),
        lambda ritmo: _filtrar_por_tempo_inicial_maximo(
            ritmo_de_jogo=ritmo, tempo_maximo_inicial=tempo_maximo_inicial
        ),
    ]
...
if __name__ == "__main__":
    ...
    print("\n")
    lista, filtro = selecionar_ritmos_de_jogo(
        tempo_minimo_inicial="5:00", tempo_maximo_inicial="10:00"
    )
    mostrar_objetos(cabecalho, lista, filtro)
